//5) Dado un array de paquetes de datos, filtra aquellos que tengan un tamaño mayor
...
const paquetesFiltradosYOrdenados = paquetesDatos.filter(paquete => paquete.tamaño > 1000).sort((a,b)=>b.prioridad - a.prioridad);
